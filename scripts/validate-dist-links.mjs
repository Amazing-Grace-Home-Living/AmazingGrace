...
if (errors.length) {
  console.error(`Found ${errors.length} broken internal references in dist:\n`);
...
console.log('All checked internal dist links and asset references resolved successfully.');
